...
/**
 * Data Transfer Object for job description data sent/received via API.
 */
public class JobDTO {
    ...
    public JobDTO(String title, List<String> requiredSkills, List<String> preferredSkills,
    ...
    public static class Builder {
        ...
        public JobDTO build() {
            return new JobDTO(title, requiredSkills, preferredSkills, experience, experienceYears, education, location, noticePeriod, responsibilities, tools, rawText);
        }
    }
